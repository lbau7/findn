...
#' least two arguments, \code{n}, the sample size for which the trial is 
#' simulated, and \code{k}, that specifies how often the trial is simulated. 
#' The function has to return an estimate for the power of the trial for the 
#' sample size \code{n} based on \code{k} Monte Carlo simulations.
#' 
